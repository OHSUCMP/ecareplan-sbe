...
insert into resource_categorization_valueset (dataSetName, valuesetName, valuesetOid, commonName) values
    ...
    ('LAB_RESULTS', 'Alanine Aminotransferase (ALT) in Blood, Plasma, or Serum', '2.16.840.1.113762.1.4.1222.1607', 'ALT'),
    ...
    ('LAB_RESULTS', 'Aspartate Aminotransferase (AST) in Blood, Plasma, or Serum', '2.16.840.1.113762.1.4.1222.1608', 'AST'),
    ...
    ('LAB_RESULTS', 'Bilirubin lab test', '2.16.840.1.113762.1.4.1248.223', 'Bilirubin'),
    ...
    ('LAB_RESULTS', 'C reactive protein (Tests by Any Method)', '2.16.840.1.113762.1.4.1146.1933', 'C reactive Protein (CRP)'),
    ...
    ('LAB_RESULTS', 'Erythrocyte Sedimentation Rate (ESR) in Blood', '2.16.840.1.113762.1.4.1222.1609', 'Erythrocyte Sedimentation Rate (ESR)'),
    ...
    ('LAB_RESULTS', 'Oxygen Saturation in Blood', '2.16.840.1.113762.1.4.1222.1610', 'Oxygen Saturation'),
    ...
    ('LAB_RESULTS', 'OIA_Thyroid_Stimulating_Hormone_(TSH)', '2.16.840.1.113762.1.4.1078.863', 'Thyroid Stimulating Hormone (TSH)'),
    ...
    ('LAB_RESULTS', 'Cardiac troponin LOINC', '2.16.840.1.113762.1.4.1078.1136', 'Cardiac troponin'),
