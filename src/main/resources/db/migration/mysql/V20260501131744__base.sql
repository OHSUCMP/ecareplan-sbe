...
insert into default_query (dataSetName, query, strategy) values ('MEDICATIONS', 'MedicationRequest?patient={PATIENT}&status=on-hold,cancelled,completed,stopped&_sort=-date&_total=10&_revinclude=Provenance:target', 'PATIENT');
...
insert into default_query (dataSetName, query, strategy) values ('VITALS', 'Observation?patient={PATIENT}&code=http://loinc.org|8867-4&date=ge{TWO_YEARS_AGO}&sort=-date&_total=10&_revinclude=Provenance:target', 'PATIENT');
insert into default_query (dataSetName, query, strategy) values ('VITALS', 'Observation?patient={PATIENT}&code=http://loinc.org|59408-5&date=ge{TWO_YEARS_AGO}&sort=-date&_total=10&_revinclude=Provenance:target', 'PATIENT');
insert into default_query (dataSetName, query, strategy) values ('VITALS', 'Observation?patient={PATIENT}&code=http://loinc.org|8310-5&date=ge{TWO_YEARS_AGO}&sort=-date&_total=10&_revinclude=Provenance:target', 'PATIENT');
insert into default_query (dataSetName, query, strategy) values ('VITALS', 'Observation?patient={PATIENT}&code=http://loinc.org|29463-7&date=ge{TWO_YEARS_AGO}&sort=-date&_total=10&_revinclude=Provenance:target', 'PATIENT');
insert into default_query (dataSetName, query, strategy) values ('VITALS', 'Observation?patient={PATIENT}&code=http://loinc.org|8302-2&date=ge{TWO_YEARS_AGO}&sort=-date&_total=10&_revinclude=Provenance:target', 'PATIENT');
insert into default_query (dataSetName, query, strategy) values ('VITALS', 'Observation?patient={PATIENT}&code=http://loinc.org|39156-5&date=ge{TWO_YEARS_AGO}&sort=-date&_total=10&_revinclude=Provenance:target', 'PATIENT');
insert into default_query (dataSetName, query, strategy) values ('VITALS', 'Observation?patient={PATIENT}&code=http://loinc.org|85354-9&date=ge{TWO_YEARS_AGO}&sort=-date&_revinclude=Provenance:target', 'PATIENT');
insert into default_query (dataSetName, query, strategy) values ('VITALS', 'Observation?patient={PATIENT}&code=http://loinc.org|72076-3&date=ge{TWO_YEARS_AGO}&sort=-date&_revinclude=Provenance:target', 'PATIENT');
