...
public abstract class ObservationModel extends BaseDataSetModel<Observation> {
    ...
    public ObservationModel(Observation observation) {
        ...
        if (observation.hasComponent() && FhirUtil.hasCoding(observation.getCode(), BP_PANEL_CODING) && observation.hasComponent()) {
            MyQuantity systolic = getQuantityFromComponent(SYSTOLIC_CODING, observation.getComponent());
            MyQuantity diastolic = getQuantityFromComponent(DIASTOLIC_CODING, observation.getComponent());
    ...
    protected MyQuantity getQuantityFromComponent(Coding coding, List<Observation.ObservationComponentComponent> components) {
    ...
    protected static final class MyQuantity {
        public final String value;
        public final String unit;

        public MyQuantity(String value, String unit) {
            this.value = value;
            this.unit = unit;
        }
